...
localStorage.setItem("countTheRightAnswers", "0")

  if(rightAnswer === answer){
    let countTheRightAnswers = localStorage.getItem("countTheRightAnswers");
    localStorage.setItem(countTheRightAnswerscountTheRightAnswers++);
    console.log(attempts);
  }else{
    console.log('bad')
  }
  (rightAnswer === answer)?console.log('dobrze'):console.log('zle')
}
